...
/**
 * Usage php set-entry-manager.php [/path/to/a/remote/directory]
 *
 * Examples:
 *
 *    php set-entry-manager.php
 *    php set-entry-manager.php /
 *    php set-entry-manager.php ./files
 */
...
/**
 * Class MyOwnSpecificEntryManager
 *
 * This is your own entry manager, probably for a specific FTP server which output for the command LIST cannot be parsed
 * by the default entry manager.
 */

class MyOwnSpecificEntryManager extends \dbeurive\Ftp\AbstractEntryManager {
...
// You set the entry manager you just implemented.
// Please note that you can set it right after the instantiation of the Ftp object.
// But you must set it BEFORE issuing any command that deals with entries (LIST...).
$ftp->setEntryManager(MyOwnSpecificEntryManager::class);

// Then you can run the FTP command LIST, if you want.
$entries = null;
